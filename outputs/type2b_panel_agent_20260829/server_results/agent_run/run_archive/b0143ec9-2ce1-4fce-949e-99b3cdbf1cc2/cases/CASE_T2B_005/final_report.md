...
Retrospective review integrated 0 FHIR evidence resources across 2 reported variant(s), identified 1 structured evidence issue(s), and found 10 missing evidence item(s). The evidence-constrained second-level plan prioritizes RIPA, VWF_MULTIMER. Current subtype tendencies are type_2_vwd (score 2.0, moderate). All requested second-level tests were explicitly unavailable in this retrospective environment; no values were imputed. The system abstains from autonomous diagnosis and requires expert review.
