...
### 3. AI 机制证据
- alphagenome_full_profile: AlphaGenome complete-profile selected-track scores; top absolute views: ag_chip_histone_active_abs_max=9834, ag_chip_tf_active_abs_max=1253, ag_cage_active_abs_max=159.1, ag_dnase_active_abs_max=32.22, ag_rna_seq_active_abs_max=16.18. Splice-axis signal: ag_splice_junctions_abs_max=6.477, ag_splice_site_usage_abs_max=0.8135, ag_splice_sites_abs_max=0.6812.
...
- Observation/computational-result-9c1701e2d729e03de6e0
...
- vwf_domain_annotator returned not_found; this is not benign evidence.
