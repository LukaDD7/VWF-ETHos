# VWD Research Report — CASE_T2B_001
...
### 1. 临床与实验室表型
VWF:Ag=76.0, VWF:Act=35.7, FVIII:C=50.7, 血小板计数=94.0。
VWF:Act/VWF:Ag 比值为 0.470，低于 0.70，提示存在不成比例的功能性 VWF 缺陷。
临床背景中存在血小板减少线索，需与 2B/血小板型 VWD 鉴别。

### 2. 变异与功能域
- c.3946G>A / p.Val1316Met（VWFA1）。
...
- CASE_T2B_001
- CASE_T2B_001:alphagenome-full-profile
- CASE_T2B_001:VWF_V1316M:boltz2-functional-panel
- CASE_T2B_001:V1316M:targeted-md
...
- Observation/computational-result-1510e27a4e3e89b6f2f3
- Observation/computational-result-a6cbbb5485b843c5a368
- Observation/computational-result-e05889eb54bf3fa6b7cf
- Observation/vwf-domain-1316-Val-Met
- Observation/local-clingen-0-290
